...
public class NotesAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public NotesAdapter(List<Note> notelst, MainActivity ma){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.individual_note, parent, false);
